...
const SignIn = () => {
    return (
        <div>
             <section>
            <div class="flex  min-h-screen overflow-hidden flex-wrap ">
                  ...
                  <div class="mt-8">
                    ...
                    ">
                          <div class="flex items-center justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" class="w-6 h-6" viewBox="0 0 48 48">
                              <defs>
