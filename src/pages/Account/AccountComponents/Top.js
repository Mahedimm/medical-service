    ...
    return (
        <div>
            <div className="mb-6 lg:mb-20 w-full  flex items-center justify-between">
                ...
                <a className="py-2 px-6 text-xs rounded-l-xl rounded-t-xl bg-green-600 hover:bg-green-700 text-white font-bold transition duration-200" href=" ">{props.children}</a>
            </div>
        </div>
    );
};
