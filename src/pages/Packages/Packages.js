              ...
              <div class="p-8 bg-gray-900 rounded">
                <div class="mb-4 text-center">
                  ...
                  <div class="flex items-center justify-center">
                    ...
                    <p class="text-lg text-gray-500">/ 3 month</p>
                  </div>
                </div>
                <ul class="mb-8 space-y-2">
                  <li class="flex items-center">
                    ...
                    <p class="font-medium text-gray-300">Unlimited video consultations with family doctors</p>
                  </li>
                  <li class="flex items-center">
                    <div class="mr-3">
                      <svg
...
Unlimited consultations with nutritionist</p>
                  ...
                  <li class="flex items-center">
                    ...
                    <p class="font-medium text-gray-300">Unlimited consultations with gynecologist</p>
                  </li>
                  <li class="flex items-center">
                    <div class="mr-3">
                      <svg
                    ...
                    <p class="font-medium text-gray-300">Registration for up to 4 family members</p>
                  </li>
                  <li class="flex items-center">
                    <div class="mr-3">
                      <svg
                    ...
                    <p class="font-medium text-gray-300">25% discount on lab tests</p>
                  </li>
                </ul>
                <button
                  type="submit"
              ...
              <div class="p-8 bg-gray-900 rounded">
                <div class="mb-4 text-center">
                  ...
                  <div class="flex items-center justify-center">
                    ...
                    <p class="text-lg text-gray-500">/ 6 month</p>
                  </div>
                </div>
                <ul class="mb-8 space-y-2">
                  <li class="flex items-center">
                  ...
                  <li class="flex items-center">
                    ...
                    <p class="font-medium text-gray-300">Unlimited consultations with nutritionist</p>
                  </li>
                  <li class="flex items-center">
                    <div class="mr-3">
                      <svg
