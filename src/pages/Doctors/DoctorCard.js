...
const DoctorCard = (props) => {
    ...
    return (
        <div>
                ...
                <div class="container mx-auto max-w-sm rounded-lg overflow-hidden shadow-lg my-2
                hover:shadow-xl transform  bg-white hover:scale-110 transition duration-500">
                    <div class="relative z-10" style={{clipPath:"polygon(0 0, 100% 0, 100% 100%, 0 calc(100% - 5vw))"}}>
                ...
                <div class="text-center absolute w-full" style={{bottom: "4rem"}}>
                    ...
                    <p class="text-yellow-300 text-sm">{category}</p>
                </div>
                </div>
                <div class="relative flex justify-between items-center flex-row px-6 z-50 -mt-10">
                <p class="flex items-center text-gray-400">
                    <span class="inline-block w-3 h-3 bg-green-500 rounded-full mr-2">
                    </span>
                    online
                </p>
                ...
                <div class="pl-2 pb-8 text-center">
                <div
                            ...
                            <Link className="hidden lg:inline-block py-2 px-6 bg-green-500 hover:bg-green-600 text-sm text-white font-bold rounded-l-xl rounded-t-xl transition duration-200" to={`/doctor/${key}`}>Appointment</Link>
                            </div>
                ...
                <div class="posts">
                <button class="bg-green-600 font-semibold text-white p-2 w-32 rounded-full hover:bg-red-700 focus:outline-none focus:ring shadow-lg hover:shadow-none transition-all duration-300 m-2 flex justify-evenly content-center justify-items-center items-center">
                <FiPhoneCall />
                    CaLL 
                </button>
                </div>
                <div class="followers">
                    ...
                    <p class="text-lg font-semibold text-blue-300">{followers}</p>
                </div>
                <div class="following">
                    <p class="text-gray-400 text-sm">Price</p>
                    <p class="text-lg font-bold text-blue-300">{price}৳</p>
                </div>
                </div>
            </div>
